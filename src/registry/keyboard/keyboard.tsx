...
export const Keypad = () => {
  return (
    <div className="h-full w-fit rounded-2xl bg-[#e5e7eb] p-2 shadow-lg shadow-black/10">
      {/* Function Row */}
      <Row>
        <Key
          keyCode="Escape"
      ...
      <Row>
        ...
        {/* Arrow Keys */}
        <div className="flex h-6 w-[4.9rem] items-center justify-end gap-1">
          <Key keyCode="ArrowLeft" className="h-6 w-6">
            <IconCaretLeftFilled className="h-[6px] w-[6px]" />
          </Key>
          <div className="flex flex-col gap-0.5">
            <Key keyCode="ArrowUp" className="h-[11px] w-6">
              <IconCaretUpFilled className="h-[6px] w-[6px]" />
            </Key>
            <Key keyCode="ArrowDown" className="h-[11px] w-6">
...
const Row = ({ children }: { children: React.ReactNode }) => (
  <div className="mb-1.5 flex w-full shrink-0 gap-1.5">{children}</div>
);
  ...
  return (
    <div className={cn("rounded-lg", containerClassName)}>
      <button
        ...
        className={cn(
          "flex h-6 w-6 cursor-pointer items-center justify-center rounded-md bg-white shadow-[0_1px_3px_rgba(0,0,0,0.1),0_1px_2px_rgba(0,0,0,0.06)] transition-all duration-100 hover:shadow-[0_1px_4px_rgba(0,0,0,0.12)] active:scale-[0.97]",
          isPressed &&
          "scale-[0.97] bg-gray-50 shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)]",
          className,
        )}
      >
        <div
          className={cn(
            "flex h-full w-full flex-col items-center justify-center text-[5px] font-medium text-gray-700",
            childrenClassName,
          )}
        >
          {children}
...
const ModifierKey = ({
  ...
  return (
    <div className={cn("rounded-lg", containerClassName)}>
      ...
      >
        <div className="flex h-full w-full flex-col items-start justify-between p-1 text-[5px] font-medium text-gray-700">
          {children}
        </div>
      </button>
    </div>
