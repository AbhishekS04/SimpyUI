...
export default function TwoStep({ phone = '62*****626', onComplete }: { phone?: string; onComplete?: (code: string) => void }) {
	...
	return (
		<div className="bg-white dark:bg-[#161B22] border border-gray-200 dark:border-gray-800 p-6 sm:p-8 rounded-2xl shadow-2xl w-full max-w-md mx-auto">
